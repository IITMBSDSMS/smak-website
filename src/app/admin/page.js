                ...
                <div className="pt-4 border-t border-white/5 space-y-4">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                     ...
                     <div>
                       ...
                       <input type="text" value={editingMem.director_sign || ''} onChange={e=>setEditingMem({...editingMem, director_sign: e.target.value})} placeholder="Leave blank to use Director Name" className="w-full bg-black border border-gray-700 rounded px-3 py-2 text-white focus:border-blue-500 focus:outline-none transition" />
                     </div>
                   </div>
